/* ---------------------------------------------------------------------------
   ...
   TO ENABLE: replace POSTHOG_KEY with your project API key from
   PostHog > Settings > Project > Project API Key, and set POSTHOG_HOST to your
   region ("https://us.i.posthog.com" or "https://eu.i.posthog.com").

   Until the key is filled in, this file does nothing and loads no third-party
   script — so the site stays fast and cookie-free out of the box.
   --------------------------------------------------------------------------- */
(function () {
  "use strict";

  var POSTHOG_KEY = "";                            // e.g. "phc_xxxxxxxxxxxxxxxx"
